...
class CurveEnv(S.StudyEnv):
    ...
    def project(self,cmd):
        ...
        # The final candidate includes the road speed limit in its feasible
        # set, rather than inheriting the old +5 m/s outer emergency boundary.
        limit=S.R.V_FREE
...
def main():
    ...
    codehash=digest();out=ROOT/'runs/frozen_s7_r2';out.mkdir(parents=True,exist_ok=True)
    f=out/'progress.json'
