...
PY
echo "[门 2] 闭环探针"; python3 -u visual_dev/v4_probe_closed_loop.py --config v4_cpu.json --out runs/probes/v4_probe_closed_loop.json > runs/v4_probe2_stdout.txt 2>&1 || { echo "GATE2_FAILED: 探针异常"; exit 1; }
